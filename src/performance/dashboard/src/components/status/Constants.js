...
export const MESSAGE_LIVEMETRICS_MICROPROFILE = 'Your project has all the prerequisite modules. However this feature it is not currently available because the metrics capability has has been secured.';
