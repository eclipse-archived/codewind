...
import { Modal, TextInput, TextArea, TextInputSkeleton, Dropdown} from 'carbon-components-react';
    ...
    render() {
        ...
        return (
            <Modal
                ...
                modalLabel={TranslatedText(this.props.lang, "page.tests.modifylabel", "Test Parameters")}
                modalHeading={TranslatedText(this.props.lang, "page.tests.modifyheading", "Modify load run configuration")}
