...
public class MicroprofileProjectCache extends AbstractMicroclimateTest {
	
	private static String exposedPort;
	private static String projectName = "libertycache";
	...
	public void TestAcreate(){
		...
		try {
			...
			Logger.println(MicroprofileProjectCache.class, "TestAcreate()", "HttpResult is: " + HttpResult);
			assertTrue(HttpResult == HttpURLConnection.HTTP_ACCEPTED);
		}catch(Exception e) {
			Logger.println(MicroprofileProjectCache.class, "TestAcreate()", "Exception occurred during project creation: " + e.getMessage(),e);
	...
	public void TestBcheckForContainer() {
		try {
			...
			Logger.println(MicroprofileProjectCache.class, "TestCcheckForContainer()", "Exposed Port is " + exposedPort);
			assertNotNull("exposedPort for project " + projectName +" is null", exposedPort);
		}catch(Exception e) {
			Logger.println(MicroprofileProjectCache.class, "TestCcheckForContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestCcheckEndpoint() {
		...
		try {
			...
			Logger.println(MicroprofileProjectCache.class, "TestEcheckEndpoint()", "Exception occurred when checking for endpoint",e);
