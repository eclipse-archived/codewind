...
public class ShutdownAPITests extends AbstractMicroclimateTest {
	...
	private static String projectNameSwift = "swift" + SUITE_TYPES.apitest + (new Date().getTime());
	...
	public void TestA001createLiberty() {
		...
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestA001createLiberty()", "HttpResult is: " + httpResult);
			assertEquals(HttpURLConnection.HTTP_ACCEPTED, httpResult);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestA001createLiberty()", "Exception occurred during project creation: " + e.getMessage(),e);
	...
	public void TestA002createSpring() {
		...
		try {
			int httpResult = MicroclimateTestUtils.projectCreation(urlParameters, testType);
			Logger.println(ShutdownAPITests.class, "TestA002createSpring()", "HttpResult is: " + httpResult);
			assertEquals(HttpURLConnection.HTTP_ACCEPTED, httpResult);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestA002createSpring()", "Exception occurred during project creation: " + e.getMessage(),e);
			fail("Exception occurred during project creation.");
		}
	...
	public void TestA003createNode() {
		...
		try {
			int httpResult = MicroclimateTestUtils.projectCreation(urlParameters, testType);
			Logger.println(ShutdownAPITests.class, "TestA003createNode()", "HttpResult is: " + httpResult);
			assertEquals(HttpURLConnection.HTTP_ACCEPTED, httpResult);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestA003createNode()", "Exception occurred during project creation: " + e.getMessage(),e);
			fail("Exception occurred during project creation.");
		}
	...
	@Test(timeout=60000) //60 seconds timeout
	public void TestA004createSwift() {
		String urlParameters  ="{\"name\": \"" + projectNameSwift + "\",\"language\": \"swift\"}";
		
		try {
			int httpResult = MicroclimateTestUtils.projectCreation(urlParameters, testType);
			Logger.println(ShutdownAPITests.class, "TestA004createSwift()", "HttpResult is: " + httpResult);
			assertEquals(HttpURLConnection.HTTP_ACCEPTED, httpResult);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestA004createSwift()", "Exception occurred during project creation: " + e.getMessage(),e);
			fail("Exception occurred during project creation.");
		}
	...
	public void TestB001checkForLibertyProject() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestB001checkForLibertyProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
	...
	public void TestB002checkForSpringProject() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestB002checkForSpringProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
			fail("Exception occurred when looking for project in projectList");
		}	
	}
	...
	public void TestB003checkForNodeProject() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestB003checkForNodeProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
			fail("Exception occurred when looking for project in projectList");
		}	
	}
	
	@Test(timeout=30000) //30 seconds timeout
	public void TestB004checkForSwiftProject() {
		try {
			while ( true ) {
				if (MicroclimateTestUtils.checkProjectExistency(projectNameSwift, testType))
					return;
				else
					Thread.sleep(3000);
			}
			...
			Logger.println(ShutdownAPITests.class, "TestB004checkForSwiftProject()", "Exception occurred when looking for project in projectList: " + e.getMessage(),e);
			fail("Exception occurred when looking for project in projectList");
		}	
	}
	...
	public void TestC001checkForLibertyContainer() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestC001checkForLibertyContainer()", "Exposed Port is " + exposedPort);
			assertNotNull("exposedPort for project " + projectNameLiberty +" is null", exposedPort);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestC001checkForLibertyContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
	...
	public void TestC002checkForSpringContainer() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestC002checkForSpringContainer()", "Exposed Port is " + exposedPort);
			assertNotNull("exposedPort for project " + projectNameSpring +" is null", exposedPort);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestC002checkForSpringContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
			fail("Exception occurred when looking for exposedport");
		}
	...
	public void TestC003checkForNodeContainer() {
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestC003checkForNodeContainer()", "Exposed Port is " + exposedPort);
			assertNotNull("exposedPort for project " + projectNameNode +" is null", exposedPort);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestC003checkForNodeContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
			fail("Exception occurred when looking for exposedport");
		}
	...
	@Test(timeout=300000) //5 mins timeout
	public void TestC004checkForSwiftContainer() {
		try {
			exposedPort = MicroclimateTestUtils.getexposedPort(projectNameSwift, testType, PROJECT_TYPES.swift);
			Logger.println(ShutdownAPITests.class, "TestC004checkForSwiftContainer()", "Exposed Port is " + exposedPort);
			assertNotNull("exposedPort for project " + projectNameSwift +" is null", exposedPort);
		}
		catch( Exception e ) {
			Logger.println(ShutdownAPITests.class, "TestC004checkForSwiftContainer()", "Exception occurred when looking for exposedport: " + e.getMessage(),e);
			fail("Exception occurred when looking for exposedport");
		}
	...
	public void TestDshutdown() {
		...
		try {
			...
			Logger.println(ShutdownAPITests.class, "TestDshutdown()", "Testing projects shutdown ");
			...
			Logger.println(ShutdownAPITests.class, "TestDshutdown()", "Socket msg     : " + se.getMsg());
			assertEquals("Unexpected socket event received", projectValidatedEvent, se.getMsg());
			Logger.println(ShutdownAPITests.class, "TestDshutdown()", "Socket event details : " + se.getDetails().toString());
			...
			if (testType.equalsIgnoreCase("local")) {
				...
				assertFalse("Swift container should be removed", MicroclimateTestUtils.existContainer(projectNameSwift));
				...
				assertFalse("Swift image should be removed", MicroclimateTestUtils.existImage(projectNameSwift));
				...
				File SwiftprojectDirectory = new File(MicroclimateTestUtils.workspace + projectNameSwift);
				...
				assertTrue("Swift project in workspace should not be removed", SwiftprojectDirectory.exists());
				...
				try {
					...
					Logger.println(ShutdownAPITests.class, "TestDshutdown()", "Exception occurred during get pod: " + e.getMessage(),e);
				...
				try {
					...
					assertTrue("Swift project in workspace should not be removed", MicroclimateTestUtils.existDirICP(pod, projectNameSwift));
				} catch (Exception e) {
					Logger.println(ShutdownAPITests.class, "TestIdelete()", "Exception occurred during check workspace: " + e.getMessage(),e);
				...
				try {
					...
					assertFalse("Swift pod should be removed", MicroclimateTestUtils.existPod(projectNameSwift));
				} catch (Exception e) {
					Logger.println(ShutdownAPITests.class, "TestIdelete()", "Exception occurred during check if pod still exists: " + e.getMessage(),e);
			...
			Logger.println(ShutdownAPITests.class, "TestDshutdown()", "Exception occurred during projects shutdown: " + e.getMessage(),e);
