...
export class ShellExtensionProject implements IExtensionProject {
    ...
    private setLanguage = async (projectInfo: ProjectInfo): Promise<void> => {
        ...
        try {
            const result = await processManager.spawnDetachedAsync(
                projectInfo.projectID,
                `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`,
                args,
                {});
    ...
    init = async (projectInfo: ProjectInfo): Promise<void> => {
        ...
        this.config = await fs.readJson(`${constants.projectConstants.projectsExtensionDir}${this.id}/.sh-extension`);
    ...
    create = (operation: Operation): void => {
        projectUtil.containerCreate(operation, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`, "create");
    }
    ...
    update = (operation: Operation, changedFiles?: projectEventsController.IFileChangeEvent[]): void => {
        projectUtil.containerUpdate(operation, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`, "update");
    }
    ...
    start = async (projectInfo: ProjectInfo): Promise<void> => {
        await projectUtil.runScript(projectInfo, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`, "start");
    }
    ...
    stop = async (projectInfo: ProjectInfo): Promise<void> => {
        await projectUtil.runScript(projectInfo, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`, "stop");
    }
    ...
    rebuild = async (projectInfo: ProjectInfo): Promise<void> => {
        await projectUtil.runScript(projectInfo, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`, "rebuild");
    }
    ...
    deleteContainer = async (projectInfo: ProjectInfo): Promise<void> => {
        await projectUtil.containerDelete(projectInfo, `${constants.projectConstants.projectsExtensionDir}${this.id}/entrypoint.sh`);
    }
