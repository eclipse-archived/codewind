...
curl -Lo ${SRC_DIR}/pfe/extensions/codewind-appsody-extension-0.6.1.zip http://download.eclipse.org/codewind/codewind-appsody-extension/0.6.1/latest/codewind-appsody-extension-0.6.1.zip
